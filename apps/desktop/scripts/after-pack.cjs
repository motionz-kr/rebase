...
exports.default = async function afterPack(context) {
  ...
  // electron-builder does proper hardened-runtime signing and the afterSign hook
  // notarizes the app. Skip the ad-hoc re-sign so it doesn't clobber that valid
  // signature. Only the free, secret-less builds (local dev, fork PRs) fall
  // through to ad-hoc.
